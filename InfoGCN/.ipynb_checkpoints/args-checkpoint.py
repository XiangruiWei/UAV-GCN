...
def get_parser():
    ...
    # data
    parser.add_argument('--data_path', type=str, default='./data/uav/MMVRAC_CSv1.npz')
    ...
    parser.add_argument('--window_size', type=int, default=64, help='')
    # parser.add_argument('--dataset', default='ntu', help='data loader will be used')
    # parser.add_argument('--datacase', default='NTU60_CS', help='data loader will be used')
    parser.add_argument('--use_vel', type=str2bool, default=False, help='')
    parser.add_argument('--use_angle', type=str2bool, default=False, help='')
    ...
    parser.add_argument('--save_interval', type=int, default=100, help='the interval for storing models (#iteration)')
    parser.add_argument('--save_epoch', type=int, default=90, help='the start epoch to save model (#iteration)')
    ...
    parser.add_argument('--k', type=int, default=6, help='')
    ...
    parser.add_argument('--w_cl_weights', type=float, default=0.1)
